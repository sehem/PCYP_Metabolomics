...
order <- c(8,10,15,7,13,16,12,9,14,6,1,2,3,4,5,11,17)
...
Classes <- set$class
colours_classes <- c("Control" = "blue", "PCYP" = "red", 
                     "QC" = "black")
...
## Normalise each analysis to Creatinine area of ZicHILIC pos
peaklist.annotated <- annotate.compound(peaklist, "Crea", 114.0665, 287, rtlim = 5)
